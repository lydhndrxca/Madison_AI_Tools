...
def _do_restore(req: RestoreRequest) -> PropResponse:
    ...
    try:
        ...
        restore_prompt = (
            ...
            "Your job: recreate this SAME EXACT prop in the SAME EXACT composition — but rendered as if it were "
            "a real photograph of a physical object. Every surface must look like it is made of a SPECIFIC, REAL material.\n\n"
            f"{context_block}"
            ...
            "- Metal must look like SPECIFIC metal (forged iron, polished brass, brushed steel) with correct reflections and micro-scratches\n"
            "- Wood must show specific grain, growth rings, end-grain vs face-grain, proper finish (oiled, lacquered, raw)\n"
            "- Leather must show grain, pores, stitch holes, dye variation\n"
            "- Hard edges where materials meet — no soft blending between different substances\n"
            "- Mechanical parts (hinges, locks, clasps, rivets) must have precise geometry and proper tolerances\n"
            "- Decorative details (engravings, stamps, inlays) must be sharp and legible\n"
            "- Wear patterns must look physically plausible — scratches along use lines, patina in recesses\n"
            "- Background must be clean, resolved, free of noise\n\n"
